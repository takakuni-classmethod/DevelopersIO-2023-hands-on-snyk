...
5\. 合わせて、 CodeBuild に **Snyk Open Source** を組み込みます。 **flask-app/sca_buildspec.yaml** の 13 行目を編集し、 Snyk Token を貼り付けます。
...
<img src="/static/images/module4/02-04-seed-repository.png" width=100%>
