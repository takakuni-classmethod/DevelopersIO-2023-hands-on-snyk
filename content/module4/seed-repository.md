...
<img src="./../../static/images/module3/01-01-seed-repository.png" width=100%>
...
<img src="./../../static/images/module3/03-01-seed-repository.png" width=100%>
...
<img src="./../../static/images/module3/03-02-seed-repository.png" width=100%>

8\. AWS CodePipeline のダッシュボードにも入ってみると、 **devsecops-pipeline** は、 git push をしたときに自動的にトリガーされています。

<img src="./../../static/images/module3/03-03-seed-repository.png" width=100%>
...
<img src="./../../static/images/module3/03-04-seed-repository.png" width=100%>

10\. SAST の実行が成功したら、 手順 9 の詳細リンクから CodeBuild のビルドログを確認してみましょう。以下の添付画像の場合、 7 件のイシューが発生していることがわかります。

<img src="./../../static/images/module3/03-05-seed-repository.png" width=100%>
